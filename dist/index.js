...
const footprinterPinLabels$1 = {
    ...pinLabels$9,
    "pin41": [...pinLabels$9["pin41"], "thermalpad"],
};
...
const GateDriverSection = () => (jsxs(Fragment, { children: [jsx(DRV8323HRTAR, { name: "U_GATE", pcbX: 35.5, pcbY: -20, pcbRotation: 90, schX: -8.4, schY: 0, schWidth: 5.2, schHeight: 5.8, schPinArrangement: {
                leftSide: {
...
const JFC2410_1500TS = (props) => {
    const { name = "F1", ...restProps } = props;
    return (jsx("fuse", { name: name, currentRating: "5A", voltageRating: "250V", supplierPartNumbers: { jlcpcb: ["C136387"] }, manufacturerPartNumber: "JFC2410-1500TS", footprint: "res_p4.9997mm_pw2mm_ph3.2mm", cadModel: {
            ...
            pcbRotationOffset: 0,
            modelOriginPosition: { x: 0, y: -12700000070253736e-21, z: -1.35 },
        }, ...restProps }));
};
...
const footprinterPinLabels = {
    ...pinLabels$7,
    "pin9": [...pinLabels$7["pin9"], "thermalpad"],
};
...
const SMBJ30A = (props) => {
    return (jsx("chip", { pinLabels: pinLabels$6, symbol: jsxs("symbol", { children: [jsx("port", { name: "pin2", pinNumber: 2, aliases: ["A"], direction: "right", schX: 0.4, schY: 0, schStemLength: 0.3 }), jsx("port", { name: "pin1", pinNumber: 1, aliases: ["C"], direction: "left", schX: -0.4, schY: 0, schStemLength: 0.3 }), jsx("schematicpath", { points: [{ "x": -0.18, "y": 0.18 }, { "x": -0.1, "y": 0.1 }, { "x": -0.1, "y": -0.1 }, { "x": -0.02, "y": -0.18 }], strokeColor: "#880000" }), jsx("schematicpath", { svgPath: "M 0.1 -0.12 L -0.1 0 L 0.1 0.14 Z", strokeColor: "#880000" })] }), supplierPartNumbers: {
            "jlcpcb": [
                "C113998"
            ]
...
const SS36 = (props) => {
    ...
    return (jsx("diode", { name: name, pinLabels: pinLabels$5, supplierPartNumbers: {
            "jlcpcb": [
                "C16015"
            ]
...
const WJ500V_5_08_2P = (props) => {
    return (jsx("connector", { pinLabels: pinLabels$4, supplierPartNumbers: {
            "jlcpcb": [
                "C8465"
            ]
...
const WJ500V_5_08_03P_14_00A = (props) => {
    return (jsx("connector", { pinLabels: pinLabels$2, supplierPartNumbers: {
            "jlcpcb": [
                "C72334"
            ]
...
const PowerStagePhase = ({ phase, motorLabel, pcbX, schX, senseSchXPos, senseSchXNeg, connectorPin, highGate, switchNode, lowGate, sensePos, senseNeg, senseOut, adc, }) => {
    ...
    return (jsxs(Fragment, { children: [jsx(CSD18540Q5B, { name: qHigh, pcbX: pcbX, pcbY: 22, pcbRotation: 270, schX: schX, schY: 5.5, schWidth: 1.6, schHeight: 2, schSheetName: sheets.motor, schSectionName: sections.powerStage }), jsx(CSD18540Q5B, { name: qLow, pcbX: pcbX, pcbY: 8, pcbRotation: 270, schX: schX, schY: -1, schWidth: 1.6, schHeight: 2, schSheetName: sheets.motor, schSectionName: sections.powerStage }), jsx("resistor", { name: gateHigh, resistance: "10", footprint: "0603", pcbX: pcbX - 5.5, pcbY: 22, schX: schX - 2.8, schY: 7.2, schSheetName: sheets.motor, schSectionName: sections.powerStage }), jsx("resistor", { name: gateLow, resistance: "10", footprint: "0603", pcbX: pcbX - 5.5, pcbY: 8, schX: schX - 2.8, schY: -2.7, schSheetName: sheets.motor, schSectionName: sections.powerStage }), jsx("resistor", { name: gateHighPd, resistance: "100k", footprint: "0603", pcbX: pcbX - 5.5, pcbY: 17, schRotation: 270, schX: schX, schY: 2.3, schSheetName: sheets.motor, schSectionName: sections.powerStage }), jsx("resistor", { name: gateLowPd, resistance: "100k", footprint: "0603", pcbX: pcbX - 5.5, pcbY: 3, schRotation: 270, schX: schX, schY: -7, schSheetName: sheets.motor, schSectionName: sections.powerStage }), jsx("resistor", { name: shunt, resistance: "5m", footprint: "2512", manufacturerPartNumber: "RLP25FEGMR005", supplierPartNumbers: { jlcpcb: ["C393074"] }, pcbX: pcbX, pcbY: -3, schRotation: 270, schX: schX, schY: -9, schSheetName: sheets.motor, schSectionName: sections.powerStage }), jsx("resistor", { name: switchLink, resistance: "0", footprint: "1206", pcbX: pcbX, pcbY: 15, pcbRotation: 90, schRotation: 270, schX: schX + 2.6, schY: 4, schSheetName: sheets.motor, schSectionName: sections.powerStage }), jsx("resistor", { name: sensePosLink, resistance: "0", footprint: "0603", ...sensePosLinkPlacement, schX: senseSchXPos, schY: -12.5, schSheetName: sheets.motor, schSectionName: sections.powerStage }), jsx("resistor", { name: senseNegLink, resistance: "0", footprint: "0603", pcbX: pcbX + 3.5, pcbY: -8.5, pcbRotation: 180, schX: senseSchXNeg, schY: -12.5, schSheetName: sheets.motor, schSectionName: sections.powerStage }), drainPins.map((pin) => (jsx(Fragment$1, { children: jsx("trace", { name: `${qHigh}_${pin}_VM`, from: `.${qHigh} > .${pin}`, to: "net.VM", ...motorTrace }) }, `${qHigh}-${pin}`))), sourcePins.map((pin) => (jsx(Fragment$1, { children: jsx("trace", { name: `${qHigh}_${pin}_PHASE`, from: `.${qHigh} > .${pin}`, to: phaseNet, ...motorTrace }) }, `${qHigh}-${pin}`))), drainPins.map((pin) => (jsx(Fragment$1, { children: jsx("trace", { name: `${qLow}_${pin}_PHASE`, from: `.${qLow} > .${pin}`, to: phaseNet, ...motorTrace }) }, `${qLow}-${pin}`))), sourcePins.map((pin) => (jsx(Fragment$1, { children: jsx("trace", { name: `${qLow}_${pin}_SHUNT`, from: `.${qLow} > .${pin}`, to: sourceNet, ...motorTrace }) }, `${qLow}-${pin}`))), jsx("trace", { name: `${phase}_HIGH_GATE_DRIVE`, from: `.U_GATE > .${highGate}`, to: `.${gateHigh} > .pin1`, ...phaseHighGateDriveTrace }), jsx("trace", { name: `${phase}_HIGH_GATE`, from: `.${gateHigh} > .pin2`, to: `.${qHigh} > .G`, ...phaseLocalGateTrace }), jsx("trace", { name: `${phase}_HIGH_GATE_PD`, from: `.${gateHighPd} > .pin1`, to: `.${qHigh} > .G`, ...phaseLocalGateTrace }), jsx("trace", { name: `${phase}_HIGH_GATE_PD_PHASE`, from: `.${gateHighPd} > .pin2`, to: phaseNet, ...logicTrace }), jsx("trace", { name: `${phase}_LOW_GATE_DRIVE`, from: `.U_GATE > .${lowGate}`, to: `.${gateLow} > .pin1`, ...phaseLowGateDriveTrace }), jsx("trace", { name: `${phase}_LOW_GATE`, from: `.${gateLow} > .pin2`, to: `.${qLow} > .G`, ...phaseLocalGateTrace }), jsx("trace", { name: `${phase}_LOW_GATE_PD`, from: `.${gateLowPd} > .pin1`, to: `.${qLow} > .G`, ...phaseLocalGateTrace }), jsx("trace", { name: `${phase}_LOW_GATE_PD_SOURCE`, from: `.${gateLowPd} > .pin2`, to: sourceNet, ...logicTrace }), jsx("trace", { name: `${phase}_SWITCH_NODE_POWER`, from: phaseNet, to: `.${switchLink} > .pin1`, ...motorTrace }), jsx("trace", { name: `${phase}_SWITCH_NODE_DRIVER`, from: `.${switchLink} > .pin2`, to: `.U_GATE > .${switchNode}`, ...phaseSwitchTrace }), jsx("trace", { name: `${phase}_MOTOR_OUTPUT`, from: phaseNet, to: `.J_MOTOR > .${connectorPin}`, schDisplayLabel: motorLabel, ...highCurrentTrace }), jsx("trace", { name: `${phase}_SHUNT_HIGH`, from: sourceNet, to: `.${shunt} > .pin1`, schDisplayLabel: `LS_${phase}`, ...highCurrentTrace }), jsx("trace", { name: `${phase}_SHUNT_GND`, from: `.${shunt} > .pin2`, to: "net.GND", ...highCurrentTrace }), jsx("trace", { name: `${phase}_SHUNT_SENSE_POS_KELVIN`, from: `.${shunt} > .pin1`, to: `.${sensePosLink} > .pin1`, ...senseTrace }), jsx("trace", { name: `${phase}_SHUNT_SENSE_POS_DRIVER`, from: `.${sensePosLink} > .pin2`, to: `.U_GATE > .${sensePos}`, ...senseTrace }), jsx("trace", { name: `${phase}_SHUNT_SENSE_NEG_KELVIN`, from: `.${shunt} > .pin2`, to: `.${senseNegLink} > .pin1`, ...groundTrace }), jsx("trace", { name: `${phase}_SHUNT_SENSE_NEG_DRIVER`, from: `.${senseNegLink} > .pin2`, to: `.U_GATE > .${senseNeg}`, ...senseTrace }), jsx("trace", { name: `${phase}_CURRENT_ADC`, from: `.U_GATE > .${senseOut}`, to: `net.MCU_${phase}_CURRENT_ADC`, ...senseTrace })] }));
};
const PowerStageSection = () => (jsxs(Fragment, { children: [jsx(WJ500V_5_08_03P_14_00A, { name: "J_MOTOR", pcbX: 35.5, pcbY: 34, pcbRotation: 180, schX: 9, schY: 9, schWidth: 1.2, schHeight: 2, schPinArrangement: { leftSide: [1, 2, 3] }, schSheetName: sheets.motor, schSectionName: sections.powerStage }), phaseConfig.map((config) => (jsx(PowerStagePhase, { ...config }, config.phase)))] }));
...
const SchematicSheets = () => (jsxs(Fragment, { children: [jsx("schematicsheet", { name: sheets.controller, displayName: "RP2040 Control, USB & Debug", sheetIndex: 1 }), jsx("schematicsheet", { name: sheets.hall, displayName: "5 V Hall Sensor Inputs", sheetIndex: 2, children: jsx("schematicsection", { name: sections.hall, displayName: "Filtered Hall Sensor Inputs" }) }), jsx("schematicsheet", { name: sheets.encoder, displayName: "Optional Quadrature Encoder", sheetIndex: 3, children: jsx("schematicsection", { name: sections.encoder, displayName: "Filtered 5 V Encoder Inputs" }) }), jsxs("schematicsheet", { name: sheets.power, displayName: "12-24 V Input & Power Supplies", sheetIndex: 4, children: [jsx("schematicsection", { name: sections.inputProtection, displayName: "Input Protection & Bulk Capacitance" }), jsx("schematicsection", { name: sections.busSense, displayName: "DC Bus Current Sense" }), jsx("schematicsection", { name: sections.buck, displayName: "5 V Buck Regulator" })] }), jsxs("schematicsheet", { name: sheets.motor, displayName: "Three-Phase BLDC Power Stage", sheetIndex: 5, children: [jsx("schematicsection", { name: sections.gateDriver, displayName: "DRV8323H Gate Driver & Current Sense" }), jsx("schematicsection", { name: sections.powerStage, displayName: "Six-MOSFET Inverter & Motor Output" })] }), jsx("schematicsheet", { name: sheets.protection, displayName: "Temperature & Hardware Protection", sheetIndex: 6, children: jsx("schematicsection", { name: sections.temperature, displayName: "Power-Stage Temperature Interlock" }) })] }));

function Rp2040BldcController() {
    return (jsxs("board", { width: "110mm", height: "80mm", minViaHoleDiameter: "0.3mm", minViaPadDiameter: "0.45mm", layers: 2, children: [jsx("net", { name: "GND", isGroundNet: true }), jsx("net", { name: "V3V3", isPowerNet: true }), jsx("net", { name: "V5", isPowerNet: true }), jsx("net", { name: "VM", isPowerNet: true }), jsx("net", { name: "U" }), jsx("net", { name: "V" }), jsx("net", { name: "W" }), jsx("net", { name: "LS_A" }), jsx("net", { name: "LS_B" }), jsx("net", { name: "LS_C" }), jsx(SchematicSheets, {}), jsx(ControllerSection, {}), jsx(EncoderSection, {}), jsx(PowerSection, {}), jsx(GateDriverSection, {}), jsx(ProtectionSection, {}), jsx(PowerStageSection, {}), jsx("copperpour", { name: "GND_TOP", layer: "top", connectsTo: "net.GND", clearance: "0.35mm", padMargin: "0.5mm", traceMargin: "0.5mm", boardEdgeMargin: "0.5mm", coveredWithSolderMask: true }), jsx("copperpour", { name: "GND_BOTTOM", layer: "bottom", connectsTo: "net.GND", clearance: "0.35mm", padMargin: "0.5mm", traceMargin: "0.5mm", boardEdgeMargin: "0.5mm", coveredWithSolderMask: true }), jsx("hole", { diameter: "3.2mm", pcbX: -51, pcbY: 36 }), jsx("hole", { diameter: "3.2mm", pcbX: 51, pcbY: 36 }), jsx("hole", { diameter: "3.2mm", pcbX: -51, pcbY: -36 }), jsx("hole", { diameter: "3.2mm", pcbX: 51, pcbY: -36 }), jsx("silkscreentext", { text: "RP2040 BLDC CONTROLLER", fontSize: "1.5mm", pcbX: 0, pcbY: 37 }), jsx("silkscreentext", { text: "12-24V / REV A PROTOTYPE", fontSize: "1mm", pcbX: 0, pcbY: 34.5 }), jsx("silkscreentext", { text: "12-24V POWER", fontSize: "1mm", pcbX: -47, pcbY: 21 }), jsx("silkscreentext", { text: "HALL", fontSize: "0.9mm", pcbX: -48, pcbY: -16 }), jsx("silkscreentext", { text: "ENCODER", fontSize: "0.9mm", pcbX: -47, pcbY: -35 }), jsx("silkscreentext", { text: "ONE MOTOR: U V W", fontSize: "1mm", pcbX: 35.5, pcbY: 27 })] }));
}
