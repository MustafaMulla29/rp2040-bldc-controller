...
const RVT1V101M0607 = (props) => {
    ...
    return (jsx("capacitor", { name: name, capacitance: "100uF", maxVoltageRating: "35V", polarized: true, supplierPartNumbers: { jlcpcb: ["C72478"] }, manufacturerPartNumber: "RVT1V101M0607", footprint: "cap_p5.3398mm_pw3.5mm_ph1.2mm", cadModel: {
...
const SMBJ33A = (props) => {
    ...
    return (jsx("diode", { name: name, supplierPartNumbers: { jlcpcb: ["C173526"] }, manufacturerPartNumber: "SMBJ33A", footprint: "res_p4.7214mm_pw2.0475mm_ph2.1924mm", cadModel: {
...
const PowerSection = () => (jsxs(Fragment, { children: [jsx(WJ500V_5_08_2P, { name: "J_POWER", pcbX: -52, pcbY: 28, pcbRotation: 90, schX: -12.12, schY: 5, schSheetName: sheets.power, schSectionName: sections.inputProtection }), jsx("fuse", { name: "F_INPUT", currentRating: "5A", voltageRating: "32V", schShowRatings: true, footprint: "1812", pcbX: -43, pcbY: 28, schX: -8.88, schY: 5, schSheetName: sheets.power, schSectionName: sections.inputProtection }), jsx("resistor", { name: "R_BUS_SHUNT", resistance: "5m", footprint: "2512", manufacturerPartNumber: "RLP25FEGMR005", supplierPartNumbers: { jlcpcb: ["C393074"] }, pcbX: -35, pcbY: 28, schX: -8, schY: -1, schSheetName: sheets.power, schSectionName: sections.busSense }), jsx(SMBJ33A, { name: "D_TVS", pcbX: -29, pcbY: 29, pcbRotation: 90, schRotation: 270, schX: -2, schY: 2, schSheetName: sheets.power, schSectionName: sections.inputProtection }), jsx(RVT1V101M0607, { name: "C_VM_BULK1", pcbX: -23, pcbY: 27, schRotation: 270, schX: 0.5, schY: 2, schSheetName: sheets.power, schSectionName: sections.inputProtection }), jsx(RVT1V101M0607, { name: "C_VM_BULK2", pcbX: -16, pcbY: 30, schRotation: 270, schX: 3, schY: 2, schSheetName: sheets.power, schSectionName: sections.inputProtection }), jsx("capacitor", { name: "C_VM_HF", capacitance: "1uF", footprint: "1206", pcbX: -9.5, pcbY: 27, schRotation: 270, schX: 5.5, schY: 2, schSheetName: sheets.power, schSectionName: sections.inputProtection }), jsx(INA240A1PWR, { name: "U_BUS_SENSE", noConnect: ["NC"], pcbX: -35, pcbY: 21, schX: -8, schY: -4, schWidth: 2.15, schHeight: 2.8, schPinArrangement: {
                leftSide: [1, 2, 3, 4],
                rightSide: [8, 7, 6, 5],
