...
const JFC2410_1500TS = (props) => {
    ...
    return (jsxRuntime.jsx("fuse", { name: name, currentRating: "5A", voltageRating: "250V", supplierPartNumbers: { jlcpcb: ["C136387"] }, manufacturerPartNumber: "JFC2410-1500TS", footprint: "res_p4.9997mm_pw2mm_ph3.2mm", cadModel: {
...
const SMBJ30A = (props) => {
    return (jsxRuntime.jsx("chip", { pinLabels: pinLabels$6, symbol: jsxRuntime.jsxs("symbol", { children: [jsxRuntime.jsx("port", { name: "pin2", pinNumber: 2, aliases: ["A"], direction: "right", schX: 0.4, schY: 0, schStemLength: 0.3 }), jsxRuntime.jsx("port", { name: "pin1", pinNumber: 1, aliases: ["C"], direction: "left", schX: -0.4, schY: 0, schStemLength: 0.3 }), jsxRuntime.jsx("schematicpath", { points: [{ "x": -0.18, "y": 0.18 }, { "x": -0.1, "y": 0.1 }, { "x": -0.1, "y": -0.1 }, { "x": -0.02, "y": -0.18 }], strokeColor: "#880000" }), jsxRuntime.jsx("schematicpath", { svgPath: "M 0.1 -0.12 L -0.1 0 L 0.1 0.14 Z", strokeColor: "#880000" })] }), supplierPartNumbers: {
            "jlcpcb": [
                "C113998"
            ]
...
const PowerSection = () => (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(WJ500V_5_08_2P, { name: "J_POWER", pcbX: -52, pcbY: 28, pcbRotation: 90, schX: -12.12, schY: 5, schSheetName: sheets.power, schSectionName: sections.inputProtection }), jsxRuntime.jsx(JFC2410_1500TS, { name: "F_INPUT", schShowRatings: true, pcbX: -43, pcbY: 28, schX: -8.88, schY: 5, schSheetName: sheets.power, schSectionName: sections.inputProtection }), jsxRuntime.jsx("resistor", { name: "R_BUS_SHUNT", resistance: "5m", footprint: "2512", manufacturerPartNumber: "RLP25FEGMR005", supplierPartNumbers: { jlcpcb: ["C393074"] }, pcbX: -35, pcbY: 28, schX: -8, schY: -1, schSheetName: sheets.power, schSectionName: sections.busSense }), jsxRuntime.jsx(SMBJ30A, { name: "D_TVS", pcbX: -29, pcbY: 29, pcbRotation: 90, schRotation: 270, schX: -2, schY: 2, schSheetName: sheets.power, schSectionName: sections.inputProtection }), jsxRuntime.jsx(RVT1H101M0607, { name: "C_VM_BULK1", pcbX: -23, pcbY: 27, schRotation: 270, schX: 0.5, schY: 2, schSheetName: sheets.power, schSectionName: sections.inputProtection }), jsxRuntime.jsx(RVT1H101M0607, { name: "C_VM_BULK2", pcbX: -16, pcbY: 30, schRotation: 270, schX: 3, schY: 2, schSheetName: sheets.power, schSectionName: sections.inputProtection }), jsxRuntime.jsx("capacitor", { name: "C_VM_HF", capacitance: "1uF", footprint: "1206", pcbX: -9.5, pcbY: 27, schRotation: 270, schX: 5.5, schY: 2, schSheetName: sheets.power, schSectionName: sections.inputProtection }), jsxRuntime.jsx(INA240A1PWR, { name: "U_BUS_SENSE", noConnect: ["NC"], pcbX: -35, pcbY: 21, schX: -8, schY: -4, schWidth: 2.15, schHeight: 2.8, schPinArrangement: {
                leftSide: [1, 2, 3, 4],
                rightSide: [8, 7, 6, 5],
